...
public class DocumentoControllerTest {
    ...
    void testGetDocumentoEndpointSuccess() throws Exception {
    ...
    @Test
    @TestSecurity(user = "testUser", roles = {"USER"})
    void testGetDocumentoEndpointUnauthorized() throws Exception {
    ...
    @Test
    @TestSecurity(user = "testUser", roles = {"USER"})
    void testGetDocumentoEndpointVinculoTrancado() throws Exception {
    ...
    @Test
    @TestSecurity(user = "testUser", roles = {"USER"})
    void testGetDocumentoEndpointInternalError() throws Exception {
    ...
    @Test
    @TestSecurity(user = "testUser", roles = {"USER"})
    void testGetDocumentoComTipoNulo() {
    ...
    @Test
    @TestSecurity(user = "testUser", roles = {"USER"})
    void testGetDocumentoComSenhaNula() {
    ...
    @Test
    @TestSecurity(user = "testUser", roles = {"USER"})
    void testGetDocumentoComTipoESenhaNulos() {
